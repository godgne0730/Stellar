...
?>      
        <div class="event_box">
            ...
            <div class="event_box_text">
                ...
                <div class="text_tr">
                    <button onclick=" self.location.href= 'event_detail_signup2.php?event_name=<?php echo $eventRow['event_name'];?>&event_date=<?php echo $eventRow['event_date'];?>&event_info=<?php echo $eventRow['event_info'];?>' ">瀏覽資訊</button>
                </div>
            </div>
        </div>
<?php
